...
- **Auxiliar de T.I** – Hospital Santa Casa de Campo Mourão  
  Suporte técnico, manutenção de redes, sistemas hospitalares e atendimento a colaboradores.  

- **Desenvolvedor Full-Stack**  
  Criação de websites, sistemas em HTML, CSS, JavaScript, PHP, Java, SQL e Python.  

- **Design Gráfico & Web Design**  
  Criação de layouts, identidade visual e interfaces web funcionais.  
...
- Inovando com CSS
- HTML e CSS na Prática (24h)
- Design Thinking – Sebrae EAD
- Fundamentos do Design 
- Uso do Design em Políticas Públicas
- Photoshop Avançado
- Edição de Vídeos no Sony Vegas Pro
